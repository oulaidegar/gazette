...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // We should check if session is created immediately or if confirmation needed
            // For now, redirect to home or a "check your email" page
            // Assuming auto-confirm for dev, or handled by middleware
            router.push('/');
        } catch (err: any) {
            ...
            <div className="w-full max-w-md space-y-8">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Start building your legal library
                    </p>
                </div>
